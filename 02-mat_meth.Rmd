...
alt_veg <-
  ...
  theme(legend.position = c(0.8, 0.25),
    ...
    scale_fill_manual(values = viridis::rocket(n = 4), 
                      labels = c("Lowlands \ndry/wet", 
                                 "Montane \nforests", 
                                 "Grasslands \nShrublands", 
                                 "Submontane \nforests")) +
...
base_plot_grob_no_pts <- ggplotGrob(base_plot_ST)
...
plot_ST_full <- gridExtra::grid.arrange(grobs = list(alt_veg, base_plot_grob, alt_veglg),
                        layout_matrix = rbind(c(3,3, 1, 2, 2, 2, 2),
                                              c(3,3, 1, 2, 2, 2, 2),
                                              c(NA,NA, 1, 2, 2, 2, 2)))

plot_ST_not_pts <- gridExtra::grid.arrange(grobs = list(alt_veg, base_plot_grob_no_pts, alt_veglg),
                        layout_matrix = rbind(c(3,3, 1, 2, 2, 2, 2),
                                              c(3,3, 1, 2, 2, 2, 2),
                                              c(NA,NA, 1, 2, 2, 2, 2)))


grid.draw(plot_ST_not_pts)


ggsave(
  "Fig12_plotS_ST_not_pts.eps",
  device = "eps",
  path = "C:/Users/dauby/Dropbox/Photos livre STP/introduction/",
  dpi = 300,
  width = 25,
  height = 10,
  plot = plot_ST_not_pts
)
...
alt_veg <-
  ...
  theme(legend.position = c(0.8, 0.25),
        ...
        axis.ticks = element_blank(),
        plot.margin=unit(c(0,0,0.5,0.5), "cm")) +
    scale_fill_manual(values = viridis::rocket(n = 2, direction = - 1), 
                      labels = c("Lowlands \nmoist/wet", 
                                 "Submontane \nforests")) +
  guides(fill = "none")
...
base_plot_grob_P_no_pts <- ggplotGrob(base_plot_P)
...
plot_P_full <- gridExtra::grid.arrange(grobs = list(alt_veg, base_plot_grob_P, alt_veglg),
                        layout_matrix = rbind(c(3,3, 1, 2, 2, 2, 2),
                                              c(3,3, 1, 2, 2, 2, 2),
                                              c(NA,NA, 1, 2, 2, 2, 2)))

plot_P_not_pts <- gridExtra::grid.arrange(grobs = list(alt_veg, base_plot_grob_P_no_pts, alt_veglg),
                        layout_matrix = rbind(c(3,3, 1, 2, 2, 2, 2),
                                              c(3,3, 1, 2, 2, 2, 2),
                                              c(NA,NA, 1, 2, 2, 2, 2)))


grid.draw(plot_P_not_pts)

ggsave(
  "Fig13_plot_P_not_pts.eps",
  device = "eps",
  path = "C:/Users/dauby/Dropbox/Photos livre STP/introduction/",
  dpi = 300,
  width = 25,
